...
INSERT INTO "new_Threshold" ("content", "createdAt", "duration", "id", "notodoId", "title", "updatedAt", "weight") SELECT "content", "createdAt", "duration", "id", "notodoId", "title", "updatedAt", "weight" FROM "Threshold";
