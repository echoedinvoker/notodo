  ...
  return (
    <>
      <div className="absolute peer hidden group-hover:flex inset-y-0 -right-3 w-8 flex-col justify-around items-center" {...props}>
        ...
        <label
          htmlFor={name}
          className="bg-stone-300 peer-checked:bg-stone-50 rounded-full z-40 before:content-[':'] peer-checked:before:content-['✕'] before:text-lg before:w-6 before:h-6 before:rounded-full before:flex before:items-center before:justify-center hover:before:bg-stone-200 before:duration-200"
        ></label>
      </div>
